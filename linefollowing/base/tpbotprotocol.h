...
enum
{
    ...
    CMD_POLL_LOOP_TIME    = 4, // base -> robot: request line-following loop timing (value1/value2 unused)
    CMD_LOOP_TIME_REPORT  = 5, // robot -> base: value1 = last loop time (ms), value2 = max loop time since boot (ms)
};
